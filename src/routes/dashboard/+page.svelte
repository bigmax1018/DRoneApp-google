...
<div class="page page-home">
	...
	<div class="page-content content-area pt-40 pb-0">
		...
		<div class="container">
			...
			<!-- Products -->
			<div data-space-between="20" data-slides-per-view="auto" data-centered-slides="false" class="swiper swiper-init main-swiper mb-40 overlay-swiper1">
			...
			<div data-space-between="20" data-slides-per-view="auto" data-centered-slides="false" class="swiper swiper-init mb-40 main-swiper categories-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Cafe</a></h5>
					...
					<div class="swiper-slide">
						<div class="categories-bx">
							<div class="icon-bx">
								<a href="/products/">
									<svg enable-background="new 0 0 48 48" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
										<g id="surface1">
										<path  fill="#fff" style="stroke:none;fill-rule:nonzero;fill-opacity:1;" d="M 22.199219 2.101562 L 21.898438 1.800781 C 20.851562 0.601562 19.199219 0 17.699219 0 C 16.199219 0 14.550781 0.601562 13.351562 1.800781 L 1.800781 13.351562 C -0.601562 15.75 -0.601562 19.5 1.800781 21.898438 L 2.101562 22.199219 C 3.148438 23.398438 4.800781 24 6.300781 24 C 7.800781 24 9.449219 23.398438 10.648438 22.199219 L 22.351562 10.5 C 24.601562 8.25 24.601562 4.351562 22.199219 2.101562 Z M 21.148438 9.601562 L 15.300781 15.449219 L 10.050781 10.050781 L 4.351562 15.75 C 2.699219 17.398438 2.699219 19.5 2.851562 21 C 1.050781 19.199219 1.050781 16.351562 2.851562 14.550781 L 14.550781 2.851562 C 15.300781 1.949219 16.5 1.5 17.699219 1.5 C 18.898438 1.5 20.101562 1.949219 21 2.851562 L 21.300781 3.148438 C 22.050781 3.898438 22.5 5.101562 22.5 6.300781 C 22.5 7.5 22.050781 8.699219 21.148438 9.601562 Z M 21.148438 9.601562 "/>
										</g>
										</svg>
								</a>
							</div>
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Farmacia</a></h5>
			...
			<!-- Featured Beverages -->
			<div class="title-bar">
				<h4 class="dz-title">Promociones</h4>
				...
				<ul class="row">
					<li class="col-100 medium-50">
						<div class="item-bx item-list">
							...
							<div class="dz-info">
								<div class="dz-head">
									<h6 class="item-title"><a href="/item-details/">Burger King Villa Mella</a></h6>
								</div>
								<div class="dz-meta">
									<ul>
										<li class="price">-5%</li>
					...
					<li class="col-100 medium-50">
						<div class="item-bx item-list">
							...
							<div class="dz-info">
								<div class="dz-head">
									<h6 class="item-title"><a href="/item-details/">Farmacia Popular Zona Colonial</a></h6>
								</div>
								<div class="dz-meta">
									<ul>
